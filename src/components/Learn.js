        ...
        <div className="flex flex-col md:flex-row w-full md:w-5/6 p-8 md:p-0">
          <div className="flex flex-col w-full md:w-1/2">
            ...
            <p className="text-md text-gray-600">
              New to MyBricks? Get to know the fundamentals of the MyBricks
              ecosystem with our beginner guides and practical tips on
              everything property investing, cryptocurrency & NFTs.
            </p>
          </div>
          ...
          <div className="md:ml-48 w-full md:w-1/2 flex flex-row justify-center md:justify-start items-center md:items-start pt-4 md:pt-0">
            <a
              className="w-1/2"
              href="https://docs.mybricksfinance.com/knowledge-base/learning-resources/amas"
              target="_blank"
            >
              <div className="w-full md:w-1/3 h-[110px] pl-4">
                <img
                  className="h-[105px] teamAvatar special"
                  src="https://mybricksfinance.com/assets/images/ama_videos.svg"
                ></img>
              </div>
              <h1 className="text-lg text-[#002159]">
                AMA Videos <span className="text-2xl ">➔</span>
              </h1>
            </a>
            <a
              className="w-1/2"
              href="https://docs.mybricksfinance.com/knowledge-base/the-bricks-token/tokenomics"
              target="_blank"
            >
              <div className="w-full md:w-1/3 h-[110px] pl-4">
                <img
                  className="h-[100px] teamAvatar special"
                  src="https://mybricksfinance.com/assets/images/brick_playlist.svg"
                ></img>
              </div>
              <h1 className="text-lg text-[#002159]">
                BRICKS Basics <span className="text-2xl">➔</span>
              </h1>
            </a>
          </div>
        </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start items-center md:items-start space-y-2 md:space-y-0">
            <div className="w-full md:w-1/2 pb-4">
              <video
                ...
                controls
                poster="https://devmybricks.s3.eu-west-2.amazonaws.com/62096e38cd9093001ad95fb4.jpeg"
                src="https://devmybricks.s3.eu-west-2.amazonaws.com/62096e67cd9093001ad95fb8.mp4"
              ></video>
            </div>
            <h2 className="text-lg text-gray-600 font-semibold">
              MyBricks Wallet
            </h2>
            <h1 className="text-2xl text-[#002159] font-semibold">
              How to create your MyBricks Wallet
            </h1>
            <p className="text-sm md:w-[65%]">
              Learn everything you need to know about the MyBricks Wallet. The
              MyBricks Wallet will be launched once FCA authorisation is
              obtained.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start items-center md:items-start space-y-2 md:space-y-0">
            <div className="w-full md:w-1/2 pb-4">
              <video
                className="rounded-xl pt-4"
                controls
                poster="https://devmybricks.s3.eu-west-2.amazonaws.com/62096ebf7c5f480014f8fc61.jpeg"
                src="https://devmybricks.s3.eu-west-2.amazonaws.com/62096ecc7c5f480014f8fc63.mp4"
              ></video>
            </div>
            <h2 className="text-lg text-gray-600 font-semibold">
              What is BNB?
            ...
            <h1 className="text-2xl text-[#002159] font-semibold">
              What is BNB and why do you need it?
            </h1>
            <p className="text-sm md:w-[65%]">
              BNB is a fundamental part of the MyBricks ecosystem. Find out what
              it is and why we use it here at MyBricks.
            </p>
          </div>
        </div>
